...
from model_dense import DenseNet, model_path, init_cnn, device
...
"""
File: /d2l-practise/modern-cnn/DenseNet/train.py
...
def main():
    ...
    model = DenseNet(num_classes).to(device).eval()
