...
from model_anynet import RegNetX32, model_path, init_cnn, device
...
"""
File: /d2l-practise/modern-cnn/AnyNet/train.py
...
def main():
    ...
    model = RegNetX32(num_classes).to(device).eval()
    ...
    # setting log file
    log_path = parent_dir / "regnet.log"
